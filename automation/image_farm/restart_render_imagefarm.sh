...
cd /home/paperspace/code/aru_sil_core && RENDER_BLOCKS_ROOT=$SEG/blocks_ns/$CFG RENDER_RUN_GLOB='splat_runs_high/*/high/*/config.yml' \
  RENDER_CKPT_POSES=opengl RENDER_SKY=${RENDER_SKY:-0,0,0} RENDER_NATIVE_INTRINSICS=${RENDER_NATIVE_INTRINSICS:-1} RENDER_VRAM_BUDGET=${RENDER_VRAM_BUDGET:-8} RENDER_PRELOAD=1 RENDER_MAX_BLOCKS=1 \
