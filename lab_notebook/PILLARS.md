...
- [good] REGRESSION HARNESS exists (2026-08-12, roadmap Phase 1 closed) — Tier A: K-domain consistency (01/02 clean; legacy skew on 03/04/05 now VISIBLE, Q4 owns), ledger_v2 datum invariants, embedder round-trip; Tier B: block_001 scene-baseline probe @2k iters vs committed expected values; unified pipeline hardened the same day (kf mono = K authority, kf_json_from_mono, --registry-only) — proven by 02's fresh run
